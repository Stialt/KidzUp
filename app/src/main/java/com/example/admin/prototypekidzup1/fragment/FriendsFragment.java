...
public class FriendsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        mFriendsList = mMainView.findViewById(R.id.frag_friends_recycle_list);
        searchET = mMainView.findViewById(R.id.frag_friends_search_text);
        searchButton = mMainView.findViewById(R.id.frag_friends_search_button);
        nothingtoShow = mMainView.findViewById(R.id.frag_friends_nothing_to_show);
    ...
    private void loadFriends(final String searchText) {
        ...
        } else friendRefQuery = friendRef.limitToLast(20);
